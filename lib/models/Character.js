...
class Character extends BaseModel {
    ...
    async saveCharacterRaidProgression(raidData) {
        ...
        await Promise.allSettled([
            this.setStats(raidData.Profile.Stats),
            this.setExperience(raidData.Profile.Info.Experience),
            this.setQuests(raidData.Profile.Quests),
            this.setConditionCounters(raidData.Profile.ConditionCounters),
            this.setEncyclopedia(raidData.Profile.Encyclopedia),
            this.setTradersInfo(raidData.Profile.TradersInfo),
            this.setUnlockedInfo(raidData.Profile.UnlockedInfo),
            this.setHideout(raidData.Profile.Hideout),
            this.setSkills(raidData.Profile.Skills),
            this.setHealth(raidData.Health),
        ]).then(() => this.solve());
