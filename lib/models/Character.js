...
const { logger, getCurrentTimestamp, generateMongoID, round, min, floor, cloneDeep } = require("../utilities");
...
class Character extends BaseModel {
    ...
    async splitItems(item) {
        ...
        const newItems = await cloneDeep(splitedItem);
    ...
    async splitItem(itemId, splitStackCount, slotId, containerId, location) {
        ...
        if (item) {
            ...
            const newItem = await newItemModel.createAsNewItemWithParent(containerId);
