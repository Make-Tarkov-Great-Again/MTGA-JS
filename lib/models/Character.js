...
class Character extends BaseModel {
    ...
    async setHealth(healthData) {
        ...
        for (const bodyPart in this.Health.BodyParts) {
            this.Health.BodyParts[bodyPart].Health.Current = round(healthData.Health[bodyPart].Current);
    ...
    async splitItems(item) {
        ...
        newItems.splice([location, slotId, parentId], 1);
