...
class Ragfair extends BaseModel {
        ...
        switch (request.body.sortType) {
            ...
            case 5: // Price
                offers.sort((a, b) => {
                    ...
                    //return this.priceSortCurrencyConversion(a) - this.priceSortCurrencyConversion(b);
                });
                break;
    ...
    /**
     * Calculate proper price based on conversion
     * @param {object} offer 
     * @returns {<Promise> int}
    
    static async priceSortCurrencyConversion(offer) {
        switch (offer.requirements[0]._tpl) {
            case "5449016a4bdc2d6f028b456f": //roubles
                return offer.requirements[0].count;
            case "569668774bdc2da2298b4568": //euros
                return offer.requirements[0].count * 117;
            case "5696686a4bdc2da3298b456a": //dollars
                return offer.requirements[0].count * 110;
        }
    }
     */
