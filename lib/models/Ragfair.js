...
const {
    getCurrentTimestamp, generateItemId,
    logger, findChildren, writeFile, readParsed,
    getAbsolutePathFrom, stringify, templatesWithParent,
...
class Ragfair extends BaseModel {
    ...
    async initialize() {
        ...
        this.categories = await Ragfair.formatCategories(categories, this.offers);
    }
