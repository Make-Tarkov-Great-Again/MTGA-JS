...
class Location extends BaseModel {
    ...
    static async generateLocationData(mapName){
        ...
        output = await this.generateBase(output, location);
        output = await this.generateStaticLoot(output, location);
        output = await this.generateQuestLoot(output, location);
        output = await this.generateWeaponsLoot(output, location);
        //output = await this.generateLooseLoot(output, location);
        return output;
    }

    static async generateBase(output, location)
    {
      output = wipeDepend(location.base);
      return output;
    }
    ...
    static async generateStaticLoot(output, location){
    ...
    static async generateQuestLoot(output, location){
      let quests = location.lootSpawns.quests;
    ...
    static async generateWeaponsLoot(output, location){
    ...
    static async generateLooseLoot(output, location){
        let looseLoot = location.lootSpawns.dynamic;
