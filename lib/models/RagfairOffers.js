...
class RagfairOffers extends BaseModel {
    constructor() {
        super();
    }
    ...
    async setOfferDuration(timestamp) {
        this.startTime = timestamp - 3600;
        this.endTime = timestamp + 3600;
    }
    ...
    async loadOffer(offerNumber, itemData, user) {
        ...
        await this.setOfferDuration(offerTimestamp);
...
module.exports.RagfairOffers = RagfairOffers;
