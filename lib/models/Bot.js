...
class Bot extends BaseModel {
    ...
    static async initializeBotPreload() {
        const { database: { core: { gameplay: { bots: { preloadParameters: { maxPreloadThreshold, maxBossPreloadThreshold } } } },
    ...
    async generateExperience(role) {
        ...
        else if (["followerBirdEye", "followerBigPipe", "followerTagilla", "bossTagilla",
