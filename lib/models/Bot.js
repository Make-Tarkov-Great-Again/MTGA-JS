...
class Bot extends BaseModel {
    ...
    async generateInfo(role, difficulty) {
        ...
        const templateInfoSettings = this.template.Info.Settings;
    ...
    async generateHealth(role, difficulty) {
        ...
        if (difficulty in database.bot.bots[role].health) {
            templateHealth = database.bot.bots[role].health[difficulty];
        } else if (database.bot.bots[role].health) {
            templateHealth = database.bot.bots[role].health;
        } else {
            templateHealth = database.bot.bots["assault"].health["impossible"];
