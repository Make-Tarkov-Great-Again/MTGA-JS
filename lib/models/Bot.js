        ...
        if (botInfo.names[role]) {
            ...
            switch (role) {
                ...
                case "followerStormtrooper":
                    choice = await getRandomFromArray(botInfo.names.generalFollower);
                    return choice;

                case "usec": case "bear":
                    choice = await getRandomFromArray(botInfo.names.normal);
                    return choice;

                default:
                    choice = await getRandomFromArray(botInfo.names.scav);
                    return choice;
            }
        }
    }
