...
class Bot extends BaseModel {
    ...
    async generateInventoryItems(parentId, role) {
        ...
        return [weapon, patron_in_weapon, cartridge, scabbard, ...head, ...body];
    }
    ...
    async generateHeadwear(parentId, role, conflicts) {
    ...
    async generateFaceCover(parentId, role, conflicts) {
    ...
    async generateEarpiece(parentId, role, conflicts) {
        const earpieces = await BotUtilities.generateLootBucket("Earpiece", role);
    ...
    async generateVisor(parentId, role, conflicts) {
    ...
    async generateTacticalVest(parentId, role) {
