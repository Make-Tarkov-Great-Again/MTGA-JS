...
class BotItemGeneration {
    ...
    static async generateBotWeapon(parentId, role, slotId, ammos = [], magazines = {}) {
        ...
        const [required, optional] = [
            cloneDeep(database.bot.weaponCache[choice].parts.required),
            cloneDeep(database.bot.weaponCache[choice].parts.optional)
        ];
        ...
        if (!database.bot.weaponCache[choice]["ammos"]) {
            ...
            if (database.bot.weaponCache[choice].ammos.includes("5e85aac65505fa48730d8af2")) {
                delete database.bot.weaponCache[choice].ammos["5e85aac65505fa48730d8af2"];
            }
        }

        ammos = cloneDeep(database.bot.weaponCache[choice].ammos);
        ...
        if (weapon._props.ReloadMode !== "OnlyBarrel") {
            ...
            magazines = cloneDeep(database.bot.weaponCache[choice].magazines);
