...
class BotItemGeneration {
    ...
    static async generateBotWeapon(botInfo, parentId, role, slotId, ammos = [], magazines = {}) {
        ...
        if (weapon._props.ReloadMode !== "OnlyBarrel") {
            magazines = botInfo.weaponCache[choice].Parts.mod_magazine;

            const filtered = await BotUtilities.cleanPartList(magazines.IDs, conflictIds);
            ...
            botInfo.weaponCache[choice].Required.mod_magazine = true;
        }
        console.log("gay")
