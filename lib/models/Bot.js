...
class Bot extends BaseModel {
    ...
    async generateSettings(settings, role, difficulty) {
        ...
        switch (true) {
            ...
            case ["bossBully", "followerBully", "bossSanitar", "bossKilla",
            ...
            case ["followerBirdEye", "followerBigPipe", "exUsec", "bossKnight",
                ...
                "followerTagilla", "pmcBot", "followerGluharSnipe", "followerGluharScout", "followerGluharSecurity", "followerGluharAssault", "followerKojaniy", "followerSanitar"].includes(role):
