...
class BotItemGeneration {
    ...
    static async generateBotWeapon(parentId, role) {
        ...
        const fullWeapon = await BotItemGeneration.generateFullWeapon(weaponTemplate, parentId);
        for (const partIndex in fullWeapon) {
            const part = fullWeapon[partIndex];
