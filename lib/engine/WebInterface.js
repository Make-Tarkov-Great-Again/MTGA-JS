...
class WebInterface {
    constructor() {
        ...
        logger.success("[WEBINTERFACE] Constructed");
    }
    ...
    async checkForSessionID(request) {
        ...
        if (sessionID) {
            ...
            await logger.debug(`[WEBINTERFACE] Found sessionID cookie: ${sessionID}`);
            return sessionID;
        }
    ...
    async getBase() {
        await logger.debug(`[WEBINTERFACE] Reading base file: ${this.baseDirectory}/base.html`);
