...
class DatabaseUtils {
    ...
    static async adjustProfiles(profiles) {
        for (const profileID in profiles) {
            ...
            if (profiles[profileID].character?._id) {
                const character = profiles[profileID].character;
                if (!character.TradersInfo["638f541a29ffd1183d187f57"]) {
                    character.TradersInfo["638f541a29ffd1183d187f57"] = {
                        "unlocked": true,
                        "disabled": false,
                        "salesSum": 100000000,
                        "standing": 99
