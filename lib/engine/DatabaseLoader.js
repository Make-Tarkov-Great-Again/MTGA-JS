...
const {
    ...
    generateUniqueId,
    read, 
    getCurrentTimestamp} = require('../../utilities');
...
class DatabaseLoader {
    ...
    static async loadTraders() {
        ...
        for (const traderID of traderKeys) {
            ...
            //assort.nextResupply = await getCurrentTimestamp() + database.core.gameplay.trading.refreshTimeInMinutes * 60;
