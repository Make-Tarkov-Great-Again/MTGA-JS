...
class DatabaseUtils {
    ...
    static async generateWeigthedWeaponItemLists() {
        let scavWeaponsFileExists = await fileExist("./assets/database/bot/scav_weapons.json");
        let scavAttachmentsFileExists = await fileExist("./assets/database/bot/scav_attachments.json");
        let raiderWeaponsFileExists = await fileExist("./assets/database/bot/raider_weapons.json");
        let raiderAttachmentsFileExists = await fileExist("./assets/database/bot/raider_attachments.json");
