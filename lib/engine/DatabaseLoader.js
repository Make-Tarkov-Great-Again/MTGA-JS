...
class DatabaseLoader {
    ...
    static async setDatabase() {
        ...
        //await BotUtilities.getFilters("55d7217a4bdc2d86028b456d");
    ...
    static async generateItems() {
        ...
        if (gameplay.development.stacksize.ammo) {
            if (items._parent === "5485a8684bdc2da71d8b4567") {
                items._props.StackMaxSize = gameplay.development.stacksize.ammo;
            }
        }
        if (gameplay.development.stacksize.money) {
            if (items._parent === "543be5dd4bdc2deb348b4569") {
                items._props.StackMaxSize = gameplay.development.stacksize.money;
            }
        }
