...
const {
    ...
    generateMongoID, round, getRandomIntInc } = require('../../utilities');
...
class DatabaseLoader {
    ...
    static async generateCore() {
        ...
        database.core.mongoIds = new MongoId(await getRandomIntInc(1,16777215)) // set id factory at core start
