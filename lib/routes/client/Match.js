...
module.exports = async function matchRoutes(app, _opts) {
    ...
    app.post("/client/match/available", async (request, reply) => {
        logger.warn(`[match/available (NOT IMPLEMENTED)] : ${request.body}`);
        return Response.zlibJsonReply(
            reply,
    ...
    app.post(`/client/match/join`, async (request, reply) => {
        logger.warn(`[match/join (NOT IMPLEMENTED)] : ${request.body}`);
        return Response.zlibJsonReply(
            reply,
            await Response.applyEmpty("null")
        );
    ...
    app.post(`/client/match/group/create`, async (request, reply) => {
        logger.warn(`[match/group/create (NOT IMPLEMENTED)] : ${request.body}`);
        return Response.zlibJsonReply(
            reply,
            await Response.applyEmpty("null")
        );
    ...
    app.post(`/client/match/group/leave`, async (request, reply) => {
        logger.warn(`[match/group/leave (NOT IMPLEMENTED)] : ${request.body}`);
        return Response.zlibJsonReply(
            reply,
            await Response.applyEmpty("null")
        );
    ...
    app.post(`/client/match/group/delete`, async (request, reply) => {
        logger.warn(`[match/group/delete (NOT IMPLEMENTED)] : ${request.body}`);
        return Response.zlibJsonReply(
            reply,
            await Response.applyEmpty("null")
        );
    ...
    app.post(`/client/match/group/exit_from_menu`, async (request, reply) => {
        logger.warn(`[match/group/exit_from_menu (NOT IMPLEMENTED)] : ${request.body}`);
        return Response.zlibJsonReply(
            reply,
            await Response.applyEmpty("null")
        );
    ...
    app.post(`/client/match/group/invite/send`, async (request, reply) => {
        logger.warn(`[match/group/invite/send (NOT IMPLEMENTED)] : ${request.body}`);
        return Response.zlibJsonReply(
            reply,
            await Response.applyEmpty("null")
        );
    ...
    app.post(`/client/match/group/invite/cancel`, async (request, reply) => {
        logger.warn(`[match/group/invite/cancel (NOT IMPLEMENTED)] : ${request.body}`);
        return Response.zlibJsonReply(
            reply,
            await Response.applyEmpty("null")
        );
    ...
    app.post(`/client/match/group/invite/accept`, async (request, reply) => {
        logger.warn(`[match/group/invite/accept (NOT IMPLEMENTED)] : ${request.body}`);
        return Response.zlibJsonReply(
            reply,
            await Response.applyEmpty("null")
        );
    ...
    app.post(`/client/match/group/status`, async (request, reply) => {
        logger.warn(`[match/group/status (NOT IMPLEMENTED)] : ${request.body}`);
        return Response.zlibJsonReply(
            reply,
