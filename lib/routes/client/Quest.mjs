...
import { logger, createLink } from "../../utilities/_index.mjs";
...
export default async function questRoutes(app, _opts) {
    ...
    app.post(`/client/quest/list`, async (request, reply) => {
        await ClientController.clientQuestList(Response.getSessionID(request), reply);
    });
