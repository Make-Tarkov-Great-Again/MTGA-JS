...
import { Trader, Trade, Item, Inventory, Ragfair, Character } from '../classes/_index.mjs';
...
export class TradeController {
    ...
    static improveTraderTradeRelations(character, characterChanges, traderId, salePrice) {
        set = { salesSum: (characterChanges.traderRelations[traderId] + salePrice) };
        characterChanges.traderRelations[traderId] = set;

        Character.setTraderRelation(character, traderId, set);
    }
