...
const { logger, round, min, max, float, getRandomInt, getRandomFromArray } = require("../utilities");
const { database: {
    core: {
...
class Durability {
    ...
    static async getBuff(toRepairUpd, isArmor) {
        ...
        toRepairUpd.Buff = {
            ...
            buffType: bonusType,
            value: bonusValue,
            thresholdDurability: await getPercentOfValue(bonusThresholdPercent, toRepairUpd.Repairable.Durability)
        };
    }
