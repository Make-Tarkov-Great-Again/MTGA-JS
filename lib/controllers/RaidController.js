...
class RaidController {
    static async raidProfileSave(request, reply) {
        const { database: { core: { gameplay: { raid: { inRaid: { insuranceEnabled } } } } } } = require('../../app').default
...
class RaidUtilities {
    ...
    static async handleInsurance(playerProfile, preraidItems, location) {
        const { database: { core: { gameplay: { development: { devInsuranceTimers, devInsuranceTimes: { min, max } } } } } } = require('../../app').default
