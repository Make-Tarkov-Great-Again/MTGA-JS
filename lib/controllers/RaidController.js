...
const { Response, getCurrentTimestamp, getRandomFromArray, getTimeDateMailFormat, getTimeMailFormat } = require("../../utilities");
...
class RaidController {
    static async raidProfileSave(request, reply) {
        ...
        for (const item of itemsToAdd) {
            ...
            const newItem = Object.create(Item.prototype);
            Object.assign(newItem, await itemTemplate.createAsNewItem());
