...
class GameController {
    ...
    static async clientGameProfileMoveItem(moveAction = null, _reply = null, playerProfile = null) {
        ...
        if (!movedItems) {
            logger.logError("[clientGameProfileMoveItem] Failed to move items, report to a developer.");
        }
        return {};
    }
