...
class GameController {
     ...
     * @returns 
     */
    static async clientGameProfileTraderRestoreHealth(moveAction = null, _reply = null, playerProfile = null) {
        const output = {
            items: {
                new: [],
                change: [],
        ...
        if (playerProfile) {
            ...
            for (const bodyPart in moveAction.difference.BodyParts) {
                if (moveAction.difference.hasOwnProperty(bodyPart)) {
                    await playerProfile.character.addHealthToBodyPart(bodyPart, moveAction.difference[bodyPart].Health);
                }
            }
        }
        return output;
     ...
     * @param {*} playerProfile
     */
    static async clientGameProfilePlayerRestoreHealth(moveAction = null, _reply = null, playerProfile = null) {
        const output = {
            items: {
                new: [],
                change: [],
