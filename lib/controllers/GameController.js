...
class GameController {
    ...
    static async clientGameProfileAcceptQuest(moveAction, playerProfile, sessionID) {
        ...
        const messageContent = await Dialogue.createMessageContent(
            ...
            10,
            (RedeemTime * 3600))
        const dialogue = await playerProfile.generateDialogue(quest.traderId, messageContent, sessionID, questReward);
        await playerProfile.sendNotificationMessage(dialogue, sessionID)
        return {};
    }
