...
class ClientController {
    ...
    static async clientMailMessageSend(request, reply) {
        ...
        if (yourDialog && theirDialog) {
            ...
            yourDialog = await Dialogue.createPlayerDialogue(request.body.dialogId, yourProfile);
            theirDialog = await Dialogue.createPlayerDialogue(request.body.dialogId, theirProfile);
