...
const { logger, FastifyResponse, payTrade, round, floor } = require("../../utilities")
...
class InsuranceController {
    ...
    static async insuranceCost(request, reply) {
        ...
        for (const traderID of request.body.traders) {
            ...
            //needs to be the item tpl for client to read totals
    ...
    static async insureItems(moveAction, playerProfile) {
        ...
        //gotta loop through payTrade function
