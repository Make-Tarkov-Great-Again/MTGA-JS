    ...
    static async profileVoiceChange(request, reply) {
        ...
        return FastifyResponse.zlibJsonReply(
            ...
            FastifyResponse.applyBody({
                status: 0,
                nicknamechangedate: await round((getCurrentTimestamp()))
            })
        );
    }
    ...
    static async profileNicknameChange(request = null, reply = null) {
        ...
        switch (validate) {
            ...
            default:
                ...
                return FastifyResponse.zlibJsonReply(reply, FastifyResponse.applyBody({ status: 0, nicknamechangedate: getCurrentTimestamp() }));
        }
    }
