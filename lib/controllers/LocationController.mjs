import { Profile, Location, Response } from "../classes/_index.mjs";
...
export class LocationController {
    ...
    static async clientLocationGetLocalloot(location, variant, reply) { 
        ...
        return Response.zlibJsonReply(
            reply,
            Response.applyBody(location_preset_data)
        );
    }
    ...
    static async clientLocationGetGeneratedLoot(name, reply) {
        ...
        return Response.zlibJsonReply(
            reply,
            Response.applyBody(generated_location_data)
        );
    }
    ...
    static async testData(request, reply) {
        ...
        return Response.applyBody(location_data);
    }
}
