...
import { zlibJsonReply, applyBody, getSessionID, applyEmpty, } from "../utilities/_index.mjs";
...
export class LocationController {
    ...
    static async clientLocationGetLocalloot(location, variant, reply) { 
        ...
        return zlibJsonReply(
            reply,
            await applyBody(location_preset_data)
        );
    }
    ...
    static async clientLocationGetGeneratedLoot(name, reply) {
        ...
        return zlibJsonReply(
            reply,
            await applyBody(generated_location_data)
        );
    }
    ...
    static async testData(request, reply) {
        ...
        return await applyBody(location_data);
    }
}
