...
import {
    ...
    getModTimeFormat, getAbsolutePathFrom, readdir, isDirectory
    ...
    */
    ...
    static async tryLoadAkiMod(data, key) {
        ...
        if(data.main.includes(".ts")){
            logger.warn(`[${key}] Mod was unable to be loaded because it is a TypeScript file!`);
            return;
        }
        ...
        if (readFile.toString().includes("Object.defineProperty(exports, \"__esModule\", { value: true });")) {
            logger.warn(`[${key}] Mod was unable to be loaded because it is a compiled .ts to .js file!`);
            return;
        }
