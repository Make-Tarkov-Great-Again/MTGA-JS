 ...
 * @param Position
 * @param Rotation
 * @param Sides Unknown (Potentially Sides that can Spawn)
 * @param Categories Unknown (Spawn Categories of Players/AI?)
 * @param Infiltration Unknown (Can be Empty String)
 * @param DelayToCanSpawnSec Unknown (Seen between 4-6)
